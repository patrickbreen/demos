...
pub fn get_opcode_and_arguments(line: String, line_number: u16) -> (u8, String) {
    ...
    return_match!(r"^bpl\s+(\w{1, 20})$", 0x10, &line);
    return_match!(r"^bmi\s+(\w{1, 20})$", 0x30, &line);
    return_match!(r"^bvc\s+(\w{1, 20})$", 0x50, &line);
    return_match!(r"^bvs\s+(\w{1, 20})$", 0x70, &line);
    return_match!(r"^bcc\s+(\w{1, 20})$", 0x90, &line);
    return_match!(r"^bcs\s+(\w{1, 20})$", 0xb0, &line);
    ...
    // absolutes
    return_match!(r"^ora\s+\$([0-9a-f]{4})$",    0x0d, &line);
    return_match!(r"^ora\s+\$([0-9a-f]{4}),x$",  0x1d, &line);
    return_match!(r"^and\s+\$([0-9a-f]{4})$",    0x2d, &line);
    return_match!(r"^and\s+\$([0-9a-f]{4}),x$",  0x3d, &line);
    return_match!(r"^eor\s+\$([0-9a-f]{4})$",    0x4d, &line);
    return_match!(r"^eor\s+\$([0-9a-f]{4}),x$",  0x5d, &line);
    return_match!(r"^adc\s+\$([0-9a-f]{4})$",    0x6d, &line);
    return_match!(r"^adc\s+\$([0-9a-f]{4}),x$",  0x7d, &line);
    return_match!(r"^sta\s+\$([0-9a-f]{4})$",    0x8d, &line);
    return_match!(r"^sta\s+\$([0-9a-f]{4}),x$",  0x9d, &line);
    return_match!(r"^lda\s+\$([0-9a-f]{4})$",    0xad, &line);
    return_match!(r"^lda\s+\$([0-9a-f]{4}),x$",  0xbd, &line);
    return_match!(r"^cmp\s+\$([0-9a-f]{4})$",    0xcd, &line);
    return_match!(r"^cmp\s+\$([0-9a-f]{4}),x$",  0xdd, &line);
    return_match!(r"^sbc\s+\$([0-9a-f]{4})$",    0xed, &line);
    return_match!(r"^sbc\s+\$([0-9a-f]{4}),x$",  0xfd, &line);
    return_match!(r"^asl\s+\$([0-9a-f]{4})$",    0x0e, &line);
    return_match!(r"^asl\s+\$([0-9a-f]{4}),x$",  0x1e, &line);
    return_match!(r"^rol\s+\$([0-9a-f]{4})$",    0x2e, &line);
    return_match!(r"^rol\s+\$([0-9a-f]{4}),x$",  0x3e, &line);
    return_match!(r"^lsr\s+\$([0-9a-f]{4})$",    0x4e, &line);
    return_match!(r"^lsr\s+\$([0-9a-f]{4}),x$",  0x5e, &line);
    return_match!(r"^ror\s+\$([0-9a-f]{4})$",    0x6e, &line);
    return_match!(r"^ror\s+\$([0-9a-f]{4}),x$",  0x7e, &line);
    return_match!(r"^stx\s+\$([0-9a-f]{4})$",    0x8e, &line);
    return_match!(r"^ldx\s+\$([0-9a-f]{4})$",    0x9e, &line);
    return_match!(r"^ldx\s+\$([0-9a-f]{4}),y$",  0xae, &line);
    return_match!(r"^dec\s+\$([0-9a-f]{4})$",    0xbe, &line);
    return_match!(r"^dec\s+\$([0-9a-f]{4}),x$",  0xce, &line);
    return_match!(r"^inc\s+\$([0-9a-f]{4})$",    0xde, &line);
    return_match!(r"^inc\s+\$([0-9a-f]{4}),x$",  0xee, &line);
    return_match!(r"^sty\s+\$([0-9a-f]{4})$",    0xfe, &line);
    return_match!(r"^ldy\s+\$([0-9a-f]{4})$",    0xac, &line);
    return_match!(r"^ldy\s+\$([0-9a-f]{4}),x$",  0xbc, &line);
    return_match!(r"^bit\s+\$([0-9a-f]{4})$",    0x2c, &line);
    return_match!(r"^cpy\s+\$([0-9a-f]{4})$",    0xcc, &line);
    return_match!(r"^cpy\s+\$([0-9a-f]{4})$",    0xec, &line);

    return_match!(r"^jmp\s+\$([0-9a-f]{4})$",    0x6c, &line);
    return_match!(r"^jmp\s+(\w{1,20})$",         0x6c, &line);
